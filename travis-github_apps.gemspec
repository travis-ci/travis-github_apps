...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'A small library for fetching, storing, and renewing GitHub Apps access tokens'
  spec.description   = 'A small library for fetching, storing, and renewing GitHub Apps access tokens'
